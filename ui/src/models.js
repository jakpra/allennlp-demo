...
const modelGroups = [
    ...
    },
    {
        ...
        models: [
            ...
            {
                model: 'open-information-extraction',
    ...
    },
    {
        ...
        models: [
            {
                model: 'wikitables-parser',
                name: 'WikiTableQuestions Semantic Parser',
                component: WikiTables,
            },
    ...
    },
    {
        ...
        iconSrc: addIcon,
        defaultOpen: true,
        models: [{ model: 'user-models', name: 'Your model here!' }],
    },
];
